...
class CoupleHomeScreen extends StatefulWidget {
  ...
  @override
  State<CoupleHomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<CoupleHomeScreen> {
...
/*
  ...
  Widget build(BuildContext context) {
    print('KEG HomeScreenState build');
    return Scaffold(
          ...
          child: Container(
            ...
            child: CupertinoDatePicker(
              ...
              onDateTimeChanged: (DateTime date) {
                setState(() {
                  print('KEG setState onHeartPressed');
                  firstDay = date;
                });
              },
            ),
