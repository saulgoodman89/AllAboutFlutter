...
import 'package:allaboutflutter/flutter_in_action/fancybutton.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title:'Hot Reeload Demo'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    final incrementButton = ElevatedButton(
      ...
      onPressed: _incrementCounter, key: null,
    );
    ...
    final decrementButton = ElevatedButton(
      ...
      onPressed: _decrementCounter, key: null,
    );
